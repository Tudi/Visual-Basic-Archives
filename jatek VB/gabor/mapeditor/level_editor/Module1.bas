...
Public Const brushX = 30
Public Const brushY = 30
'load them from the ini file
Public Const BrushMaxX = 20
Public Const BrushMaxY = 20
Public Const VisibleBrushX = 13
Public Const VisibleBrushY = 13

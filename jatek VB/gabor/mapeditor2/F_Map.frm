...
Select Case KeyCode
 Case K_Right
  ...
  'If Inc_Size + cx1 + VisibleBrushWidth * BrushWidth <= MHeader.x * BrushWidth Then
    cx1 = cx1 + Inc_Size
    RefreshMap
    F_Main.Caption = Str(cx1) + "," + Str(cy1)
  '  Else
  '   MsgBox Inc_Size + cx1 + VisibleBrushWidth * BrushWidth
  '   MsgBox "<="
  '   MsgBox MHeader.x * BrushWidth
  End If
 Case K_Down

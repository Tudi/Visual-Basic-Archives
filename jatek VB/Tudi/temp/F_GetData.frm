...
Private Sub B_ok_Click()
 ...
 If (B <> 0) Then
  ...
  Else: Valtozok_tipusok.Name = T_name.Text
        ...
        If (MHeader.x <> Int(T_X.Text)) Then cx1 = 0
        If MHeader.y <> Int(T_Y.Text) Then cy1 = 0
...
Private Sub T_coment_KeyPress(KeyAscii As Integer)
 If KeyAscii = vbKeyReturn Then B_ok_Click
End Sub
...
Private Sub T_X_KeyPress(KeyAscii As Integer)
 If KeyAscii = vbKeyReturn Then B_ok_Click
End Sub

Private Sub T_Y_KeyPress(KeyAscii As Integer)
 If KeyAscii = vbKeyReturn Then B_ok_Click
End Sub

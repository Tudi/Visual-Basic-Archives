...
Public Const PathBrushImg = "\settings\brushimg6.jpg" '- a brushokrol itt talalhatunk kepeket
...
Type T_BrushStats
    ...
    CanBuild As Byte 'lehet ra epitkezni
    Mineral As Single 'mennyi mineral van benne
...
Public Const MaxUnit = 100 'egy jatekosnak ennyi unitja lehet
Public Const MaxUnitPoz = 12 'hany oszlop+1 lessz egy unit imagefilejanak elso soraba
Public Const MaxUnitType = 1 'hanyfajta unit van deklaralva
Public Type T_Unit
  ...
  Deployed As Integer ' specialis pozicio (siege tank)
  ...
  px As Single 'hany pixelt lepik egyszerre x szerint sebesseg
  py As Single 'hany pixelt lepik egyszere y szerint sebesseg
  Ax As Single
  Ay As Single
  KX As Single 'hol helyezkedik el x szerint
  KY As Single 'hol helyezkedik el y szerint
  VX As Single 'hova kell elerjen x szerint
  VY As Single 'hova kell elerjen y szerint
  Szog As Single 'majd 3D -be lessz hasznalva
  KSzog As Single 'kurens milyen szogben all a unit
  ...
  Anim As Byte 'hanyas animacio van folyamatban
  FrameAnim As Byte 'az animacio hanyadik kepenel tart
...
Public NrUnit As Integer ' hany unit van a terkepen
Public VUnit(MaxPlayer * MaxUnit) As T_Unit 'a jatekosok unitjai
Public VAnimUnit(MaxUnitType) As New AnimatedUnit
...
Public Const Down_Position = 0
Public Const Down_Right_Position = 1
Public Const Right_Position = 2
Public Const Up_Right_Position = 3
Public Const Up_Position = 4
Public Const Up_Left_Position = 5
Public Const Left_Position = 6
Public Const Down_Left_Position = 7

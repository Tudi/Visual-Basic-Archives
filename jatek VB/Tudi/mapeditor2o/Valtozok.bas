...
'Public MBrush(MaxVBrush) As T_BrushStats ' a terkep kockai milyen tulajdonsagot orokolnek
...
'Public Const mheader.x = 25
'Public Const mheader.y = 25
Public Const VisibleBrushWidth = 19
Public Const VisibleBrushHeight = 18
